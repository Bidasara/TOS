...
const Options = (props) => {
    ...
    return (
      ...
      ${theme === 'tos' ? 'tos tos-border' : theme === 'cyberpunk' ? 'cyberpunk-bg neon-text border-2 border-cyan-400' : 'bg-white dark:bg-gray-800'}`}>
            ...
            {/* Recommended Lists */}
            <h2 className={`text-lg font-bold h-1/12 ${theme === 'cyberpunk' ? 'text-cyan-400 neon-text' : 'text-indigo-800 dark:text-white'}`}>Recommended Lists</h2> 
            <div className={`h-6/12 flex flex-col gap-4 overflow-auto ${theme === 'cyberpunk' ? 'cyberpunk-scrollbar' : ''}`}>
            ...
            {/* QuickStats Section */}
            <div className={`h-3/12 quickstats-container rounded-lg shadow transition-all duration-300 ${theme === 'tos' ? 'tos tos-border' : theme === 'cyberpunk' ? 'cyberpunk-bg neon-text border border-cyan-400' : 'bg-gray-100 dark:bg-gray-700'}`}>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className={`flex flex-col justify-between p-4 rounded-lg shadow-sm transition-transform hover:transform hover:scale-[1.02] ${theme === 'tos' ? 'bg-tos-bg border border-tos-accent' : theme === 'cyberpunk' ? 'bg-black border border-pink-500 neon-text' : 'bg-indigo-50 dark:bg-indigo-900/30'}`}>
                    ...
                    <div className={`flex flex-col justify-between p-4 rounded-lg shadow-sm transition-transform hover:transform hover:scale-[1.02] ${theme === 'tos' ? 'bg-tos-bg border border-tos-accent' : theme === 'cyberpunk' ? 'bg-black border border-cyan-400 neon-text' : 'bg-green-50 dark:bg-green-900/30'}`}>
